...
<div class="contain__def center">
  <h1 class="title__pages font-blue center relaway">Desarrollo Organizacional</h1>
<section class="contain__information center">
  <article class="item__text-img flex">
    <img src="img/esca.jpg" alt="" class="center"/>
    <p class="font-gray  relaway center">
      Después de haber interactuado y apoyado a cientos de empresas de diversos tipos de negocios en ciudades de Norte América, México, Centro América y Suda América, hemos podido confirmar que una palanca de que potencia a los negocios es el TALENTO con que cuenta, aunado a este se encuentra una Cultura Organizacional alineada a los objetivos del negocio.
    <p>

  </article>

  <p class="font-gray  relaway center margin">
    Es por ello, que en WORD TALENT CONSULTING hemos logrado convertirnos en el Aliado de Negocios de diversas organizaciones, sabedores de la versatilidad de la industria nos hemos convertido en el DIFERENCIADOR Y POTENCIADOR en el desarrollo sostenido, sustentado en el POTENCIAL DE SUS COLABORADORES.
    <br>
    <br>
