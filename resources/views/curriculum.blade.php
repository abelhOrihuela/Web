...
<div class="content-wrapper2">
  <!--Contenido--------------------------------------->
  <section id="coaching__contain" class="center">
  ...
  <h5>Informacion personal</h5>
      <article class="info__person">
        ...
        <div class="campo">
          <div class="title__campo">Sexo</div>
            <select class="" name="marital_status" data-form="text">
        ...
        <div class="campo">
          <div class="title__campo">Fecha de nacimiento:</div>
            <input type="date" name="name" value="" data-form="text">
        ...
        <div class="campo">
          ...
          <input type="text" name="name" value="" data-form="text" required>
        </div>
        ...
        <div class="campo">
          ...
          <input type="tel" name="name" value="" data-form="text">
        </div>
      ...
      <article class="info__person">
        ...
        <div class="campo">
          ...
          <input type="text" name="name" value="" data-form="text" >
        </div>
      ...
      <article class="info__person">
        ...
        <div class="campo">
          ...
          <input type="number" name="name" value="" data-form="text">
        </div>
